...
// TODO: Create an aggregate function to get the total number of students overall
const headCount = async () =>
  Student.aggregate().count("studentCount")
...
const grade = async (studentId) =>
  Student.aggregate([
    ...
    {
      $group: {_id: "$first", averageGrade: { $avg: "$assignments.score" }}
    },
  ]);
